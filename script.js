...
if (num1 === 8 || num2 === 8 || num1 + num2 === 8 || num1 - num2 === 8) {
    console.log("Uno dei due numeri e' 8 oppure la loro somma/sottrazione e' 8")
} else {
    console.log("Nessuna delle condizioni e' vera")
}
...
let totalShoppingCart = 19
let totaleConSpedizione = 0
let spedizione = 10
let promoBlack = (totalShoppingCart * 20) / 100
//proporzione per il calcolo della percentuale:
if (totalShoppingCart > 50) {
    totaleConSpedizione = totalShoppingCart - promoBlack
} else {
    totaleConSpedizione = (totalShoppingCart - promoBlack) + spedizione
}
